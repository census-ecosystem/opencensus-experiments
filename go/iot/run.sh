...
CGO_ENABLED=1 GOARM=7 GOARCH=arm GOOS=linux CC=arm-linux-gnueabihf-gcc go build ./compare.go
sshpass -p $3 ssh $1@$2 "rm -rf /home/pi/main"
sshpass -p $3 scp ./main $1@$2:~/
sshpass -p $3 ssh $1@$2 "/home/pi/main &"
rm -rf ./main

sshpass -p $3 ssh $1@$2 "rm -rf /home/pi/compare"
sshpass -p $3 scp ./compare $1@$2:~/
sshpass -p $3 ssh $1@$2 "/home/pi/compare &"
rm -rf ./compare
